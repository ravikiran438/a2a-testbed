...
from a2a_testbed.core.loader import AgentCardLoadError, load_agent_card_from_str
from a2a_testbed.transport import Transport


def make_well_known_card_contract(
    ...
    async def verify() -> None:
        ...
        try:
            ...
            raise AssertionError(
                f"card body did not parse as a valid {transport.name} card: {exc}"
            )
